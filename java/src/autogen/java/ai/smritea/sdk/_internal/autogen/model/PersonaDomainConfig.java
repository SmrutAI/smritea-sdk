 ...
 */
@JsonPropertyOrder({
  PersonaDomainConfig.JSON_PROPERTY_DESCRIPTION,
  PersonaDomainConfig.JSON_PROPERTY_IS_DEFAULT,
  PersonaDomainConfig.JSON_PROPERTY_NAME,
  PersonaDomainConfig.JSON_PROPERTY_TRAITS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PersonaDomainConfig {
  ...
  public PersonaDomainConfig() { 
  }

  public PersonaDomainConfig description(@javax.annotation.Nullable String description) {
  ...
  public PersonaDomainConfig isDefault(@javax.annotation.Nullable Boolean isDefault) {
  ...
  public PersonaDomainConfig name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PersonaDomainConfig traits(@javax.annotation.Nullable List<String> traits) {
    this.traits = traits;
    return this;
  }

  public PersonaDomainConfig addTraitsItem(String traitsItem) {
    if (this.traits == null) {
  ...
  /**
   * Return true if this PersonaDomainConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PersonaDomainConfig personaDomainConfig = (PersonaDomainConfig) o;
    return Objects.equals(this.description, personaDomainConfig.description) &&
        Objects.equals(this.isDefault, personaDomainConfig.isDefault) &&
        Objects.equals(this.name, personaDomainConfig.name) &&
        Objects.equals(this.traits, personaDomainConfig.traits);
  }
