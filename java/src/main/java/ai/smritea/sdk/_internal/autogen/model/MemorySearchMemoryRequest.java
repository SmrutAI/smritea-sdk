...
public class MemorySearchMemoryRequest {
    ...
    @javax.annotation.Nullable private SearchStrategiesSearchMethod method;
    ...
    public MemorySearchMemoryRequest method(
            @javax.annotation.Nullable SearchStrategiesSearchMethod method) {
        this.method = method;
        return this;
    }
    ...
    /**
     * ValidAt filters memories valid at a specific point in time (ISO 8601 format). A memory is
     * valid if: active_from &lt;&#x3D; ValidAt AND (active_to is null OR active_to &gt;&#x3D;
     * ValidAt) Mutually exclusive with FromTime/ToTime.
     *
     * @return validAt
     */
    @javax.annotation.Nullable
