...
public class MemoryCreateMemoryRequest {
    ...
    /**
     * ActorType is the type of the actor (user|agent|system). Required when ActorID is present;
     * omit for conversation-level or app-level memories.
     */
    ...
    public static final String JSON_PROPERTY_FACT_EXTRACTION_OVERRIDES =
            "fact_extraction_overrides";
    ...
    public MemoryCreateMemoryRequest personaExtractionOverrides(
            @javax.annotation.Nullable
                    CommondtoPersonaExtractionConfig personaExtractionOverrides) {
    ...
    /**
     * RelativeStanding groups importance and temporal decay parameters. If nil on input, defaults
     * are applied (importance&#x3D;1.0, decay_factor&#x3D;0.2, decay_function&#x3D;exponential).
     *
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.activeFrom, memoryCreateMemoryRequest.activeFrom)
                ...
                && Objects.equals(
                        this.entityExtractionOverrides,
                        memoryCreateMemoryRequest.entityExtractionOverrides)
                && Objects.equals(
                        this.factExtractionOverrides,
                        memoryCreateMemoryRequest.factExtractionOverrides)
                && Objects.equals(this.metadata, memoryCreateMemoryRequest.metadata)
                && Objects.equals(
                        this.personaExtractionOverrides,
                        memoryCreateMemoryRequest.personaExtractionOverrides)
                && Objects.equals(
                        this.relativeStanding, memoryCreateMemoryRequest.relativeStanding);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getConversationMessageId() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            ApiClient.urlEncode(
                                    ApiClient.valueToString(getConversationMessageId()))));
        }
        ...
        if (getRelativeStanding() != null) {
            joiner.add(
                    getRelativeStanding().toUrlQueryString(prefix + "relative_standing" + suffix));
        }
