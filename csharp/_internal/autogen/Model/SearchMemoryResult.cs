...
namespace Smritea.Internal.Autogen.Model
{
    ...
    /// SearchMemoryResult
    /// </summary>
    [DataContract(Name = "SearchMemoryResult")]
    public partial class SearchMemoryResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchMemoryResult" /> class.
        /// </summary>
        ...
        public SearchMemoryResult(string activeFrom = default, string activeTo = default, string content = default, string id = default, Object metadata = default, MemoryScope scope = default)
        {
