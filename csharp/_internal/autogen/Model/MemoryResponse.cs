...
namespace Smritea.Internal.Autogen.Model
{
    ...
    public partial class MemoryResponse : IValidatableObject
    {
        ...
        public MemoryResponse(string activeFrom = default, string activeTo = default, string appId = default, string content = default, string createdAt = default, string id = default, Object metadata = default, RelativeStandingConfig relativeStanding = default, MemoryScope scope = default, string updatedAt = default)
        {
