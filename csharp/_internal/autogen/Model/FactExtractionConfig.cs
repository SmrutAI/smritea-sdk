...
namespace Smritea.Internal.Autogen.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FactExtractionConfig")]
    public partial class FactExtractionConfig : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FactExtractionConfig" /> class.
        /// </summary>
        ...
        public FactExtractionConfig(int maxPasses = default, int maxTokens = default, decimal minImportance = default, string model = default, StrategyEnum? strategy = default, decimal temperature = default)
        {
