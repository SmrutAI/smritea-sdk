...
namespace Smritea.Internal.Autogen.Model
{
    ...
    /// StepTrace
    /// </summary>
    [DataContract(Name = "StepTrace")]
    public partial class StepTrace : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StepTrace" /> class.
        /// </summary>
        ...
        public StepTrace(int durationMs = default, string error = default, string input = default, string output = default, int resultCount = default, string stepName = default)
        {
