...
public class SmriteaQuotaException : SmriteaException
{
    ...
    public SmriteaQuotaException(string message, int statusCode, string? errorCode = null, object? body = null)
    ...
    /// <param name="errorCode">The machine-readable error code from the server response.</param>
    /// <param name="body">The full parsed JSON response body, if available.</param>
    public SmriteaQuotaException(string message, int? statusCode = null, string? errorCode = null, object? body = null)
        : base(message, statusCode, errorCode, body)
    {
    }
    ...
    /// <param name="innerException">The inner exception.</param>
    /// <param name="body">The full parsed JSON response body, if available.</param>
    public SmriteaQuotaException(string message, int? statusCode, Exception innerException, object? body = null)
