...
class MemorySearchMemoryResult(BaseModel):
    ...
    actor_id: Optional[StrictStr] = Field(default=None, description="ActorID identifies whose memory this is.")
    actor_name: Optional[StrictStr] = Field(default=None, description="ActorName is the human-readable name of the actor.")
    actor_type: Optional[StrictStr] = Field(default=None, description="ActorType is the type of actor (user|agent|system).")
    ...
    conversation_id: Optional[StrictStr] = Field(default=None, description="ConversationID is the conversation this memory belongs to (optional).")
    ...
    __properties: ClassVar[List[str]] = ["active_from", "active_to", "actor_id", "actor_name", "actor_type", "content", "conversation_id", "id", "metadata"]
