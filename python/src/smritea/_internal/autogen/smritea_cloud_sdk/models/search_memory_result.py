...
class SearchMemoryResult(BaseModel):
    ...
    scope: Optional[MemoryScope] = Field(default=None, description="Scope contains the memory's actor, conversation, and source context.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchMemoryResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchMemoryResult from a dict"""
        if obj is None:
            return None
