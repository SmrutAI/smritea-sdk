...
class MemoryCreateMemoryRequest(BaseModel):
    ...
    conversation_id: Optional[StrictStr] = Field(default=None, description="ConversationID is the conversation identifier (optional, UUID)")
    conversation_message_id: Optional[StrictStr] = Field(default=None, description="ConversationMessageID is the conversation message identifier (optional, UUID)")
