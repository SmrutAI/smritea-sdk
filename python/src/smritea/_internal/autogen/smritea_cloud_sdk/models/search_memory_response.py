...
class SearchMemoryResponse(BaseModel):
    ...
    """ # noqa: E501
    memory: Optional[SearchMemoryResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchMemoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchMemoryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "memory": SearchMemoryResult.from_dict(obj["memory"]) if obj.get("memory") is not None else None,
            "score": obj.get("score")
        })
        return _obj
